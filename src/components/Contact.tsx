            ...
            {contactInfo.map((info, index) => <Card key={index} className="p-6 bg-white border border-gray-200 rounded-3xl shadow-sm hover:shadow-md transition-shadow duration-300">
                <CardContent className="flex items-start space-x-4 p-0">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-body text-gray-600 whitespace-pre-line font-nunito leading-relaxed rounded">{info.value}</div>
                  </div>
                </CardContent>
              </Card>)}
          </div>
          ...
          <Card className="bg-white border border-gray-200 rounded-3xl shadow-sm p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-body font-normal mb-2 text-foreground rounded">
                    Nombre *
                  </label>
              ...
              <Button type="submit" className="w-full bg-primary hover:bg-primary/90 text-white px-6 py-4 text-body font-medium rounded-xl transition-colors duration-300">
