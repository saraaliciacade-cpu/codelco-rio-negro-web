      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-20 max-w-6xl">
        ...
        <div className="mb-8 md:mb-12">
          <div className="flex flex-col lg:flex-row gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-white border border-border shadow-lg hover:shadow-xl transition-shadow duration-300 flex-1 overflow-hidden rounded-xl">
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-center gap-4 md:gap-6 max-w-full mx-auto">
          ...
          return <div key={service.id} className={`bg-white border border-border overflow-hidden transition-all duration-300 ease-in-out md:hover:scale-105 hover:shadow-xl hover:shadow-black/10 hover:z-10 relative group lg:w-80 lg:flex-shrink-0 rounded-xl ${getStaggerClass(index)}`}>
                {/* NEW Badge */}
                ...
                <div className={`px-4 py-6 md:px-6 md:py-8 text-center ${service.id === 'fabrica' || service.id === 'rental' ? 'bg-foreground' : 'bg-primary'}`}>
