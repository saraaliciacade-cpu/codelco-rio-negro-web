        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 font-nunito text-sm">
              ...
              <li><a href="https://webmail.codelco.com.ar" target="_blank" rel="noopener noreferrer nofollow" className="text-white/60 hover:text-[#e04d1c] transition-colors">Personal Codelco</a></li>
            </ul>
          </div>
        </div>
